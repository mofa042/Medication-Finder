...
def save_medication_data(file_path, data):
    try:
...
def handle_unavailable_medication(med_name):
    ...
    if user_input in ['yes', 'y', 'sure']:
        ...
        print("1. Visit your nearest pharmacy and consult a pharmacist.")
        print("2. Check reliable online sources such as official healthcare websites or medication databases.")
        print("3. Contact your healthcare provider for recommendations or alternatives.")
    else:
